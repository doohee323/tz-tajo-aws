...
public class Contact extends Controller {
  ...
  private org.slf4j.Logger Logger = org.slf4j.LoggerFactory.getLogger(Contact.class);
  ...
  public void init() {
    List<Map<String, Object>> mConf = ConfigUtil.getConfig("contact.xml", "config");
